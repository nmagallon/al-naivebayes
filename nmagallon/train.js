...
function calculateProbability(word,language,training){
    ...
    // ----------------- Your Code -----------------
    var wp = wordCountInLanguage(word,language)/training.docCounts[language];


    // probability that word is not in language
    // ----------------- Your Code -----------------
    var wnp = wordNotInLanguageCount(word, language)/training.docNotInCounts[language];
